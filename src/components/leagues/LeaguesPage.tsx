          ...
          <form onSubmit={handleCreate} className="space-y-3">
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary transition"
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 border border-gray-200 rounded-lg px-3 py-2 text-sm font-mono tracking-wider focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary transition"
                  required
                  minLength={4}
                  maxLength={10}
                />
            ...
            <button
              ...
              className="w-full bg-primary text-white rounded-xl py-2.5 text-sm font-semibold hover:bg-primary/90 transition shadow-sm shadow-primary/20 disabled:opacity-50"
            >
          ...
          <form onSubmit={handleJoin} className="space-y-3">
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm font-mono tracking-wider focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary transition"
                placeholder="ABCDEF"
                required
              />
            </div>
            ...
            <button
              ...
              className="w-full bg-green-600 text-white rounded-xl py-2.5 text-sm font-semibold hover:bg-green-700 transition disabled:opacity-50"
            >
        ...
        {userLeagues.length === 0 ? (
          ...
          <div className="divide-y divide-gray-50">
            {userLeagues.map(league => {
              ...
              return (
                <div key={league.id} className="flex items-center gap-3 px-5 py-4">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <div className="hidden sm:flex items-center gap-1 bg-gray-50 rounded-lg px-2 py-1.5">
