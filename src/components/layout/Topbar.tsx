...
export default function Topbar({ profile, onAdminClick, showingAdmin, onLiguesClick }: TopbarProps) {
  ...
  return (
    <header className="bg-dark text-white px-4 py-3 flex items-center justify-between sticky top-0 z-50 shadow-lg">
      <div className="flex items-center gap-2.5">
        <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-primary to-[#4F46E5] flex items-center justify-center shadow-lg shadow-primary/40 text-lg shrink-0">
          ⚽
        </div>
        <div>
          <div className="font-black text-sm text-white tracking-tight leading-none">HireSweet</div>
          <div className="text-[10px] text-white/50 font-medium tracking-wider uppercase">World Cup 2026</div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-1.5">
        ...
        <div className="flex items-center gap-2 px-2 py-1 rounded-lg">
          <div className="w-7 h-7 rounded-full bg-primary flex items-center justify-center text-white text-xs font-bold shrink-0 shadow-sm shadow-primary/30">
